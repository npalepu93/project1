...
import vegProducts from "./data/vegProducts.json";
...
function Veg() {
  ...
  return (
    <div style={styles.page}>
      <h1 style={styles.title}>🥗 Veg Special Dishes</h1>
      <p style={styles.subtitle}>
        Found {filteredProducts.length} vegetarian products
      </p>
